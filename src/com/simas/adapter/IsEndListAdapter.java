...
public class IsEndListAdapter<T> extends CustomAdapter {
	private ListView listView;
	private Context context;
	private List<EventIsEndBean> data; // Target Data
	private LayoutInflater inflater;

	@SuppressWarnings("unchecked")
	public IsEndListAdapter(ArrayList<T> data, Context context) {
		super(data, context);
	}

	@SuppressWarnings("unchecked")
	public IsEndListAdapter(ArrayList<T> data, ListView listView, Context context) {
		super(data, context);

		this.listView = listView;
		// asyncImageLoader = new AsyncImageLoader();
		this.context = context;
		this.data = (List<EventIsEndBean>) data;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		EventIsEndBean megInfo = (EventIsEndBean) getItem(position);
	...
	public void setData(List<EventIsEndBean> resultList) {
